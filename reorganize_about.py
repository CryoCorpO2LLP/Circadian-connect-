...
# Try to match the video container
video_match = re.search(r'(<div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-xl bg-slate-900.*?</video>\s*</div>)', about_content, re.DOTALL)
if not video_match:
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <Card className="p-6 bg-white">
                         ...
                         <p className="text-xs text-slate-600 mb-2">Visiting faculty at TISS for PPPs in Health & Child Rights. Advisory Board for the international TRANSSITION Project (Sheffield University).</p>
                      </Card>
                    </div>
                  </div>
                </div>
