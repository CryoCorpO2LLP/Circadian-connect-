...
video_player = """<div className="rounded-xl overflow-hidden border border-slate-200 shadow-lg bg-white h-full flex items-center justify-center">
                      <video src="/about_video.mp4" controls autoPlay loop muted playsInline className="w-full max-h-[300px] object-contain" />
                    </div>"""
